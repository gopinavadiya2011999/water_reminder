...
sleepTimeDialog(context, AccountController accountController, {required bool sleepTime}) {
  showDialog(
      context: context,
      builder: (context) {
                ...
                inkWell(
                    onTap: () async {
                      ...
                      if(sleepTime){
                        ...
                        FirebaseFirestore.instance.collection('user').doc(accountController.userData.first.userId).
                        update({
