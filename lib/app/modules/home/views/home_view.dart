          ...
          if (snapshotData.hasData) {
            ...
            return CircularPercentIndicator(
                ...
                percent: (int.parse((drinkableWater*200).toString()) /
                    int.parse(snapshot!['water_goal'].toString().split('ml').first.trim())) <= 1?
                      ...
                      children: [
                        ...
                        RichText(
                            text: TextSpan(
                                ...
                                children: [
                              TextSpan(
                                  text: (drinkableWater * 200).toString(),
                        ...
                        Divider(
                            height: 2,
                            thickness: 1.2,
                            color: ColorConstant.whiteD9),
                        const SizedBox(height: 5),
                        Text(
                          "You have completed ${((drinkableWater * 200) / int.parse(snapshot['water_goal'].toString().split('ml').first.trim()) * 100).floor()}% of your daily drink target",
                          maxLines: 3,
                          textAlign: TextAlign.center,
                          style:
                              TextStyleConstant.grey14.copyWith(fontSize: 12),
                        ),
                      ],
                    ),
                  ),
                    ...
                    if (snapshot.hasData) {
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return snapshot.data!.docs[index].get('time') !=
                                      null &&
                                  DateFormat('dd/MM/yyyy')
                                          .format(DateTime.now()) ==
                                      DateFormat('dd/MM/yyyy').format(
